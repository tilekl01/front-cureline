...
[data-mantine-color-scheme='light'] .m-be049a53:where([data-disabled]) {
      background-color: var(--mantine-color-gray-2);
      color: var(--mantine-color-gray-5);
}

[data-mantine-color-scheme='dark'] .m-be049a53:where([data-disabled]) {
      background-color: var(--mantine-color-dark-6);
      color: var(--mantine-color-dark-3);
}
...
@keyframes m-885901b1 {
  ...
  100% {
    opacity: 0;
    box-shadow: 0 0 0 calc(0.5rem * var(--mantine-scale)) var(--indicator-color);
  }
}
...
[data-mantine-color-scheme='light'] .m-3d733a3a:where([data-with-title]) {
      color: var(--mantine-color-gray-6);
}

[data-mantine-color-scheme='dark'] .m-3d733a3a:where([data-with-title]) {
      color: var(--mantine-color-dark-2);
}
...
@media (hover: none) {
    [data-mantine-color-scheme='light'] .m-919a4d88:active {
      background-color: var(--mantine-color-gray-0);
  }

    [data-mantine-color-scheme='dark'] .m-919a4d88:active {
      background-color: var(--mantine-color-dark-8);
  }
}
...
[data-mantine-color-scheme='light'] .m-dd33bc19:where([data-filled])[data-disabled] {
        border-color: var(--mantine-color-gray-4);
}

[data-mantine-color-scheme='dark'] .m-dd33bc19:where([data-filled])[data-disabled] {
